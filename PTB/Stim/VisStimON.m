    ...
    switch sobj.Pattern
        ...
        case 'Decode SC'
            ...
            if sobj.n_in_loop <= app.Blankloop.Value + 8
                ...
                % Stim area and grids are defined
                % @Set_StimPattern.m

                %Randomize Checker Pattern (1:white; 0:black)
                sobj.checker_pattern = uint8(randi([0,1], [sobj.Div_grid^2, 1]));

                % Select patch pattern
                if sobj.CheckerPatch
                    %Use 4x4 checer patchs
        ...
        case  {'ImageNet train', 'ImageNet test'}
            ...
            if sobj.n_in_loop <= app.Blankloop.Value + 8
                ...
                % Select one image from ImageNet_train or _test
